...
- `getDetectionRecordsOverview`
- `getDetectionRecordDetail`
- `getPilotMetrics`
- `getDashboardKpi`
- `getDashboardDefectTrend`
- `getDashboardDefectDistribution`
- `getDashboardAlerts`
- `getProductionLinesOverview`
- `getProductionLineDetail`
- `getModelManagementOverview`
