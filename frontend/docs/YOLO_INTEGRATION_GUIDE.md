...
**文件：** `src/main/java/com/deepindus/service/YoloService.java`

```java
package com.deepindus.service;
...
**文件：** `src/main/java/com/deepindus/model/DetectionResult.java`

```java
package com.deepindus.model;
...
**文件：** `src/main/java/com/deepindus/controller/DetectionController.java`

```java
package com.deepindus.controller;

import com.deepindus.service.YoloService;
import com.deepindus.service.DetectionRecordService;
import com.deepindus.model.DetectionResult;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.deepindus.websocket;
...
```java
package com.deepindus.config;

import com.deepindus.websocket.VideoStreamHandler;
import org.springframework.beans.factory.annotation.Autowired;
...
services:
  ...
  backend:
    ...
    ports:
      - "8000:8000"
    environment:
      SPRING_DATASOURCE_URL: jdbc:mysql://mysql:3306/deepindus
...
spring:
  ...
  datasource:
    url: jdbc:mysql://localhost:3306/deepindus
    username: root
    password: root123
