# DEEPINDUS 系统 - API 接口规范文档

## 📌 接口约定

### 基础信息
- **Base URL：** `http://api.deepindus.com/v1`
- **请求格式：** JSON
- **响应格式：** JSON
- **字符编码：** UTF-8
...
```json
{
  "code": 200,
  "data": {
    "downloadUrl": "https://cdn.deepindus.com/exports/records_20260201.xlsx"
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "imageUrl": "https://cdn.deepindus.com/defects/20260201/image001.jpg",
    "processRecords": [
      {
        "id": 1,
...
```json
{
  "code": 200,
  "data": {
    "url": "https://cdn.deepindus.com/uploads/20260201/file001.jpg",
...
```json
{
  "code": 200,
  "data": {
    "systemName": "DEEPINDUS",
    "version": "1.0.0",
    "websocketUrl": "ws://api.deepindus.com/ws"
  }
}
```
...
### 连接地址
```
ws://api.deepindus.com/ws?token={jwt_token}
```
